...
5. Do NOT modify any file not mentioned in the reviews. Do NOT make cosmetic changes, refactors, or cleanups beyond what the reviewer explicitly requested.
6. Run the linter (`make style && make quality`) and tests (`uv run pytest`) after making changes
