...
Check the diff against main, and remove all AI generated slop introduced in the current branch.
...
Only look at changes that we introduced in the current branch.
...
- Casts to "any" to get around type checking issues
